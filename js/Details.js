    ...
    function showgallery(currarray){
        ...
        for(var i=0;i<currarray.length;i++){
            ...
            <div class="card p-3 ps-5 pe-5">
                ...
                <p class="mt-2 ">Date:${currarray[i].date}</p>
                <p class="mt-2 ">Place:${currarray[i].place}</p>
                <p class="mt-2 ">Capacity:${currarray[i].capacity}</p>
                <p class="mt-2 ">Estimate:${currarray[i].estimate}</p>
                <p class="mt-2 ">Precio $${currarray[i].price}</p>
             
                <a href="./index.html" class="btn btn-primary w-100 mx-auto">Volver al home..</a>
            </div>
